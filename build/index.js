...
function ColorGroupControl({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Accent color'),
    colorSettings: [{
      value: accentColor,
      onChange: setAccentColor,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Accent color')
    }]
  }));
}
...
function SwiperControl({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Panel, {
    ...
    labelPosition: "top",
    value: slidesPerView,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Slides per view (number)'),
...
function Edit({
  ...
  const [width, setWidth] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_7__.useState)('auto');
  const [needsUpdate, setNeedsUpdate] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_7__.useState)(false);
  const swiper = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_7__.useRef)(null);
  ...
  const previousBlockCount = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_7__.useRef)(blockCount);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_7__.useEffect)(() => {
    if (!anchor) setAttributes({
      anchor: clientId
    });
  }, []);
  ...
  const {
    ...
    allowedBlocks: _templates__WEBPACK_IMPORTED_MODULE_5__.ALLOWED_BLOCKS,
    template: _templates__WEBPACK_IMPORTED_MODULE_5__.DEFAULT_TEMPLATE
  });
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_7__.useEffect)(() => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(SwiperControl, {
    loop: loop,
    setLoop: value => {
      setAttributes({
        loop: value
  ...
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(ColorGroupControl, {
    ...
    ref: swiper,
    className: `${className} wp-block-rm-swiper-container`,
    style: swiperStyles
...
function save({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("swiper-container", {
    ...innerBlocksProps
  }, children);
}
...
/* harmony export */ });
const DEFAULT_TEMPLATE = [['rm/swiper-slide', {}], ['rm/swiper-slide', {}]];
const FRAME_TEMPLATES = [DEFAULT_TEMPLATE];
const ALLOWED_BLOCKS = ['rm/swiper-slide'];
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"rm/swiper-container","version":"0.1.0","title":"Swiper Container","category":"widgets","icon":"align-full-width","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false,"align":true,"layout":{"default":{"type":"flex","orientation":"horizontal","flexWrap":"nowrap"}},"color":{"gradients":true,"background":true}},"attributes":{"align":{"type":"string","default":""},"slidesPerView":{"type":"string","source":"attribute","selector":"swiper-container","attribute":"slides-per-view","default":1},"loop":{"type":"boolean","source":"attribute","selector":"swiper-container","attribute":"loop"},"autoPlay":{"type":"boolean","source":"attribute","selector":"swiper-container","attribute":"autoplay"},"speed":{"type":"number","source":"attribute","selector":"swiper-container","attribute":"speed"}},"textdomain":"swiper-container","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkswiper_container"] = globalThis["webpackChunkswiper_container"] || [];
